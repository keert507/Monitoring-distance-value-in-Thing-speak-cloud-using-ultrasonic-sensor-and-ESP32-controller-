...
#include <WiFi.h>
char ssid[] = "Sona's A35"; //SSID
char pass[] = "Sona@1011"; // Password
const int trigger = 25;
const int echo = 26;
long T;
float distanceCM;
WiFiClient client;
unsigned long myChannelField = 2792095; // Channel ID
const int ChannelField = 1; // Which channel to write data
const char * myWriteAPIKey = "NZVFF7DRU4KDB7AX"; // Your write API Key
void setup()
{
Serial.begin(115200);
